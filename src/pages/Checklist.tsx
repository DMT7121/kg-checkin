...
export default function Checklist() {
  ...
  return (
    <div className="h-full flex flex-col artisan-bg animate-fade-in relative pb-24">
      <div className="p-4 flex-none">
        ...
        {/* Progress */}
        <div className="mb-6 artisan-card p-4 w-full">
      ...
      <div className="flex-1 overflow-y-auto px-4 mt-4 space-y-3">
        {loading ? (
          ...
          <div className="text-center py-10 artisan-card ">
              ...
              return (
                <motion.div
                  ...
                  className={`p-4 rounded-2xl border-2 transition-all cursor-pointer flex items-center justify-between ${
                    ...
                    : 'border-gray-100 dark:border-gray-700 artisan-card  hover:border-blue-300 dark:hover:border-blue-600'
                  }`}
                >
