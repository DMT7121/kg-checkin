  ...
  return (
    <div className="h-full flex flex-col artisan-bg animate-fade-in relative pb-6">
      ...
      <div className="px-4 relative z-20 flex-1 flex flex-col overflow-hidden space-y-4">
        ...
        {!isAdmin && (
          <div className="artisan-card p-5 shrink-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <select 
                ...
                className="w-full artisan-bg/50 border border-gray-200 dark:border-gray-700 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-purple-500/50 text-gray-800 dark:text-white text-sm"
              >
        ...
        <div className="flex-1 overflow-y-auto pb-6 no-scrollbar space-y-3">
          ...
          {loading ? (
            ...
            <div className="text-center py-8 artisan-card ">
                      ...
                      {replyingTo === fb.id ? (
                        <div className="space-y-2">
                          <textarea 
                            ...
                            className="w-full artisan-bg/50 border border-gray-200 dark:border-gray-700 rounded-lg p-2 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500"
                            rows={2}
                          ></textarea>
