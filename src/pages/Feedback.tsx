...
import { MessageSquareWarning, Send, EyeOff, CheckCircle2, User, Clock, AlertCircle, CornerDownRight } from 'lucide-react';
...
export default function Feedback() {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-900 animate-fade-in relative pb-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-6 pb-8 text-white shadow-md relative overflow-hidden shrink-0 rounded-b-3xl">
        ...
        <div className="flex items-center space-x-3 relative z-10">
          ...
          <div>
            ...
            <p className="text-xs text-purple-100 opacity-90">Kênh kết nối nhân viên và Quản lý</p>
          </div>
        </div>
      </div>
