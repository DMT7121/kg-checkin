  ...
  return (
    <div className="p-4 animate-slide-up pb-10">
      ...
      <div className="space-y-4 mb-8">
        {lessons.map(lesson => (
          <div key={lesson.id} className="soft3d-card overflow-hidden">
      ...
      <div className="soft3d-card  border border-amber-200 dark:border-amber-900/50 p-5">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-2">
              <label className="flex items-center p-3 border border-gray-200 dark:border-gray-700 rounded-xl soft3d-bg cursor-pointer">
