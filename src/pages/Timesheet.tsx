    ...
    <div className="p-4 space-y-5 animate-slide-up pb-10">
      ...
      <div className="artisan-card p-5 rounded-2xl  ">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div className="flex artisan-bg p-1 rounded-xl">
            <button
          ...
          {isAdmin && (
            <select
              ...
              className="artisan-bg border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-indigo-500 outline-none font-medium text-sm"
            >
        ...
        {selectedUser === 'ALL' && isAdmin ? (
          <div className="overflow-x-auto w-full rounded-xl border border-gray-200 dark:border-gray-700 custom-scrollbar">
            <table className="w-full text-sm text-left">
              <thead className="artisan-bg/50 text-gray-500 dark:text-gray-400 uppercase text-xs">
                <tr>
                  <th className="px-4 py-3 font-bold sticky left-0 artisan-bg z-10 border-b border-r dark:border-gray-700 min-w-[150px]">
                    Nhân viên
                  </th>
                ...
                {displayNames.map(name => {
                  ...
                  return (
                    <tr key={name} className="border-b dark:border-gray-700 hover:bg-indigo-50/30 dark:hover:bg-indigo-900/10 transition-colors">
                      <td className="px-4 py-3 font-bold text-gray-800 dark:text-gray-200 sticky left-0 artisan-card border-r dark:border-gray-700 z-10">
                        {name}
                      </td>
