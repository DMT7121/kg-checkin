...
export default function AdminPayroll() {
  ...
  return (
    <div className="p-4 space-y-4 animate-slide-up pb-10">
      ...
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 rounded-3xl p-6 md:p-8 text-white shadow-xl relative overflow-hidden flex items-center justify-between mb-6">
      ...
      <div className="soft3d-card p-5 rounded-2xl  ">
        ...
        <div className={`space-y-4 ${formulaLocked ? 'opacity-70 pointer-events-none' : ''}`}>
          <div className="p-4 soft3d-bg rounded-xl border border-dashed border-gray-300 dark:border-gray-700">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-2">
              {allowances.map(a => (
                <div key={a.id} className="flex flex-wrap justify-between items-center gap-2 soft3d-bg p-2.5 rounded-lg border border-gray-100 dark:border-gray-800">
