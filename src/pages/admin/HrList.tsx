...
export default function HrList() {
  ...
  return (
    <div className="p-4 space-y-6 animate-slide-up pb-10 max-w-5xl mx-auto">
      ...
      {/* Header Banner */}
      <div className="soft3d-card !bg-gradient-to-r from-ocean-600 via-blue-600 to-indigo-700 p-6 md:p-8 text-white relative overflow-hidden flex items-center justify-between border-opacity-30">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-center">
                  ...
                  <div className="lg:col-span-5 flex items-center min-w-0">
                    ...
                    <div className="ml-4 min-w-0 flex-1">
                      ...
                      <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 w-full">
                        <span className="font-mono bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-[10px] mr-2 flex-shrink-0">
                          @{user.username}
                        </span>
                        {user.email && (
                  ...
                  {/* Controls (Right - takes 7 columns on lg) */}
                  <div className="lg:col-span-7 bg-gray-50/50 dark:bg-gray-900/20 p-3 lg:p-0 rounded-xl lg:bg-transparent lg:dark:bg-transparent w-full">
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-3 items-end">
                      
                      {/* Position Select (Takes 2 cols on md) */}
                      ...
                      {/* Role Select (Takes 2 cols on md) */}
                      <div className="col-span-1 md:col-span-2">
                        <label className="block text-[10px] uppercase font-bold text-gray-500 dark:text-gray-400 mb-1 ml-1 flex items-center">
                      ...
                      {/* Reset Password Action (Takes 1 col on md) */}
                      <div className="col-span-2 md:col-span-1 flex justify-end md:justify-center">
                        ...
                        >
                          ...
                          <span className="md:hidden ml-2 font-medium text-sm">Khôi phục mật khẩu</span>
                        </button>
                      </div>
